...
const createApiRoutes = () => {
	...
	const handleGetModelRouter = (res) => {
		res.writeHead(200, { 'Content-Type': 'application/json' });
		res.end(JSON.stringify(modelRouter.getSnapshot()));
	};
	...
	const handleGetGitStatus = (res) => {
		res.writeHead(200, { 'Content-Type': 'application/json' });
		res.end(JSON.stringify(updateChecker.getState()));
	};
